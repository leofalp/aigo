...
// part represents a content part (text, function call, function response, inline data, file data, code execution, etc.).
type part struct {
	...
	ExecutableCode      *executableCode      `json:"executableCode,omitempty"`      // Code generated by the model for execution
	CodeExecutionResult *codeExecutionResult `json:"codeExecutionResult,omitempty"` // Result of executing the generated code
}
...
// executableCode represents code generated by the model for sandbox execution.
// Only generated when using the CodeExecution tool.
type executableCode struct {
	Language string `json:"language"` // Programming language (e.g., "PYTHON")
	Code     string `json:"code"`     // The generated code to execute
}

// codeExecutionResult represents the result of executing generated code in the sandbox.
// Always follows a part containing executableCode.
type codeExecutionResult struct {
	Outcome string `json:"outcome"`          // "OUTCOME_OK", "OUTCOME_FAILED", "OUTCOME_DEADLINE_EXCEEDED"
	Output  string `json:"output,omitempty"` // stdout on success, stderr on failure
}
...
type candidate struct {
	...
	URLContextMetadata []urlContextMeta   `json:"urlContextMetadata,omitempty"` // Metadata about URLs retrieved by the url_context tool
}
...
// urlContextMeta represents metadata about a URL retrieved by the url_context tool.
type urlContextMeta struct {
	URL                    string `json:"url"`
	Status                 string `json:"status"`                           // Retrieval status (e.g., "SUCCESS")
	RetrievedContentLength int    `json:"retrievedContentLength,omitempty"` // Length of content retrieved from the URL
}
